...
class CustomerProductOtpScreen extends StatefulWidget {
  final String title;
  final OTPScreenArgs screenArgs;
  CustomerProductOtpScreen({Key key, this.title, this.screenArgs})
      : super(key: key);
  @override
  _CustomerProductOtpScreen createState() => _CustomerProductOtpScreen();
}

class _CustomerProductOtpScreen extends State<CustomerProductOtpScreen> {
  var onTapRecognizer;
  var timerText;
  ...
  void sendOTP(String resend) {
    try {
      ...
      Map<String, String> requestMap = {
        ...
        'type': widget.screenArgs.type, //oduct_selection',
        'product_id': widget.screenArgs.productID,
        'case_id': widget.screenArgs.caseID,
        'resend': resend
      };
        ...
        if (widget.screenArgs.type == 'product_selection') {
          ...
          callApi
            ...
            if (result != null) {
              ...
              if (error == 0) {
                Navigator.pushNamed(
                    buildContext, widget.screenArgs.nextClickURL,
