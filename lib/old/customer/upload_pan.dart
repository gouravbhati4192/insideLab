        ...
        body: SafeArea(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Let us Know Your Customer\'s Income Identity',
                  style: Theme.of(context).textTheme.headline6.merge(
                        TextStyle(fontSize: 25),
                      ),
                  textAlign: TextAlign.center,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          Navigator.pushNamed(
                              context, Routes.panVerificationByDoc,
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, Routes.takePhotoPanCard,
                              arguments: widget.customerData);
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(vertical: 15),
